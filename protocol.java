...
public abstract class protocol implements MyInterface {
	...
	public protocol gitInstance(String pro) {
	...
	public  boolean relase(String pro) {
	...
	public  List<String> getCurrentCunnection(){
